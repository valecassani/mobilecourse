 ...
 */
public class LoginTFragment extends Fragment {

    private final String TAG = "Login Tutor";

    private LoginTutor activity;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View frags = inflater.inflate(R.layout.logint_frag, container, true);
        ...
        Button buttest=(Button)frags.findViewById(R.id.buttontest);
        buttest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent nintent = new Intent(getActivity(), MainActivity.class);
    ...
    public void onAttach(Activity activity) {
        ...
        this.activity = (LoginTutor) activity;
    }



    private void interfaceSettings(View view){
        progressView=(ProgressBar)view.findViewById(R.id.progressBarLT);

        mail=(EditText) view.findViewById(R.id.userT);
        password=(EditText) view.findViewById(R.id.pasT);
        noreg=(TextView) view.findViewById(R.id.noreg);
        oppure=(TextView) view.findViewById(R.id.oppure);

        reg=(Button) view.findViewById(R.id.regT);
    ...
    private void attemptLogin(){
        ...
        String url = "login_tutor.php?mail=".concat(mail.getText().toString()).concat("&password=").concat(password.getText().toString());
        // new RequestFtp().setParameters(activity, url, "logTutor", LoginSFragment.this).execute();
    ...
    private void hideElements(){
        ...
        fm.beginTransaction().hide(fbt).commit();
    ...
    private void showElements(){
        FragmentManager fm = getFragmentManager();
        //fbs=fm.findFragmentById(R.id.loginFB);
        fm.beginTransaction().show(fbt).commit();
