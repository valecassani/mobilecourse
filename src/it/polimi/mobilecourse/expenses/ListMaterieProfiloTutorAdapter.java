...
/**
 * Created by Valerio on 22/09/2015.
 */
public class ListMaterieProfiloTutorAdapter extends BaseAdapter {

    private Context context;
    private List<ListMaterieItem> items;


    public ListMaterieProfiloTutorAdapter(Context context, List<ListMaterieItem> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.materia_profilo_tutor_item, null);
        }
